...
class findFaceGetPulse(object):
    ...
    def __init__(self, bpm_limits=[], data_spike_limit=250,
        ...
        #face detection by opencv classifier
        #dpath = resource_path("haarcascade_frontalface_alt.xml")
        dpath = resource_path("haarcascade_frontalface_alt2.xml")
    ...
    def get_subface_means(self, coord):
        x, y, w, h = coord
        subframe = self.frame_in[y:y + h, x:x + w, :] #rectangle box
